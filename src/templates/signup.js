...
<button data-next="signUp" dataEmail="e-mailSignUp" dataPass="passwortSignUp" dataName="nameSignUp" dataLast="lastNameSignUp"  class="buttonRegister js" id="buttonSignUp">Registrarme</button>
<div id="root"></div>
